        ...
        for log in logs: 
            ...
            match log_entry.op: 
                case 'start':
                    ...
                    #if current_id != '': 
                    #    start_time = function_times[current_id][0].pop()
                    #    function_times[current_id][1] += int(timestamp) - start_time  
                    #elif len(function_times[id][0]) > 0:
                    #    start_time = function_times[id][0].pop()
                    #    function_times[id][1] += int(timestamp) - start_time     
                    #function_times[id][0].append(int(timestamp)) 
                case 'end': 
                    #start_time = function_times[id][0].pop()
                    #function_times[id][1] += int(timestamp) - start_time
