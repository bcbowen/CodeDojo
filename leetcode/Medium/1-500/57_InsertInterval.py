...
class Solution:
    def insert(self, intervals: List[List[int]], newInterval: List[int]) -> List[List[int]]:
        ...
        # intervals are empty - return new interval as complete list
        if intervals == []: 
            return [newInterval]
        # new interval superset of previous intervals
        ...
        for interval in intervals: 
            if in_progress: 
                if interval[0] > newInterval[1]: 
                    ...
                    #result.append([begin, interval[0]])
                ...
                if newInterval[0] < interval[0] and newInterval[1] < interval[0] and newInterval[0] > last_end:
            ...
            last_end = interval[1]
        if begin > -1: 
            result.append([begin, max(newInterval[1], intervals[-1][1])])
