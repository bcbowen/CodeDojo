...
"""
Borrowing solution from Matheus Stutzel to troubleshoot my tests: 
https://github.com/matheusstutzel/adventOfCode/
Python -> cat {day}/input | python3 {day}/p1.py

cat ~/workspace/github.com/bcbowen/adventOfCodePrivateFiles/2024/Day20/input.txt | python3 stuzel_d20p1.py
