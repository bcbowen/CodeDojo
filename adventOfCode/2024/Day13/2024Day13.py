...
def load_fixtures(file_name: str) -> list[Fixture]:
    ...
    content = Modules.aoc_io.read_input(2024, 13, file_name)
...
def part2(file_name: str) -> int:
    ...
    cost = 0
    for fixture in fixtures:
        result, fixture_cost = calc_cost2(fixture)
        if result:
            cost += fixture_cost
    return cost
...
def calc_cost(fixture: Fixture) -> tuple[bool, int]:
    ...
    result = False
    divisor = (
        fixture.ButtonA.X * fixture.ButtonB.Y - fixture.ButtonA.Y * fixture.ButtonB.X
    )
    a_dividend = (
        fixture.Prize.X * fixture.ButtonB.Y - fixture.Prize.Y * fixture.ButtonB.X
    )
    b_dividend = (
        fixture.ButtonA.X * fixture.Prize.Y - fixture.ButtonA.Y * fixture.Prize.X
    )
...
def calc_cost2(fixture: Fixture) -> tuple[bool, int]:
    """
    A = (p_x*b_y - prize_y*b_x) / (a_x*b_y - a_y*b_x)
    B = (a_x*p_y - a_y*p_x) / (a_x*b_y - a_y*b_x)
    ...
    fixture.Prize.X += offset
    fixture.Prize.Y += offset
    cost = 0
    result = False
    divisor = (
        fixture.ButtonA.X * fixture.ButtonB.Y - fixture.ButtonA.Y * fixture.ButtonB.X
...
@pytest.mark.parametrize(
    "a_x, a_y, b_x, b_y, p_x, p_y, expected_result, expected_cost",
    [
...
@pytest.mark.parametrize(
    "a_x, a_y, b_x, b_y, p_x, p_y, expected_result",
    [
        (94, 34, 22, 67, 8400, 5400, False),
        (26, 66, 67, 21, 12748, 12176, True),
        (17, 86, 84, 37, 7870, 6450, False),
        (69, 23, 27, 71, 18641, 10279, True),
    ],
)
def test_calc_cost2(
    a_x: int, a_y: int, b_x: int, b_y: int, p_x: int, p_y: int, expected_result: bool
):
    fixture = Fixture()
    fixture.ButtonA = Point(a_x, a_y)
    fixture.ButtonB = Point(b_x, b_y)
    ...
    actual_result, _ = calc_cost2(fixture)
