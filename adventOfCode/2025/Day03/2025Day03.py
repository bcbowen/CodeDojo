...
"""
@pytest.mark.parametrize("line, joltage_size, expected", [
...
@pytest.mark.parametrize("line, start, joltage_size, expected", [
...
@pytest.mark.parametrize("joltage_size, expected", [
    (2, 357), 
    (12, 3121910778619)
])
